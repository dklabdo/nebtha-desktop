  ...
  return(
    <div className="relative py-2 flex flex-col bg-white shadow-md shadow-black/30 transition w-72 h-[450px] ">
        ...
        <div className="w-full h-1/2 ">
          <h1 className="px-4 text-base font-semibold text-main" >{product.ProductName} </h1>
           <p className="px-4 h-28 my-2 py-4 line-clamp-3" >{product.Productdesc} </p>
           <div className="w-full  px-5 py-2 flex items-center justify-between">
            ...
            >
              ...
              <MenuList>
                ...
                <MenuItem onClick={()=>{setCurrentProductToModifie(product);navigate('/modifieProduct')}} className="flex items-center gap-3">
...
export function UpdateStock() {
  ...
  function HandleUpdatePriceAndStock(e){
    ...
    axios.patch(ApiUrl,PriceAndStock).then(()=>{
 ...
 function HandlePriceAndStock(){
  setPriceAndStock({...PriceAndStock,
    Promotion : promotion.current.checked,
    PromotionPrice : promotion.current.checked ? price.current.value : null,
    Price : !promotion.current.checked ? price.current.value : CurrentStockAndPrice.Price,
        ...
        <form onSubmit={(e)=>HandleUpdatePriceAndStock(e)} className="flex flex-col  w-full  ">
          <div className="flex gap-10 px-10 my-20">
            <div className="flex gap-3 w-1/2 flex-col">
              <label className="flex gap-2 px-2 items-center" htmlFor="input1">
