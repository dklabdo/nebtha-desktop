...
import HomePage, { AjouterCodePromo, AjouterConseille } from "./Pages/HomePage";
...
import ConfirmOrder, { GenerateFacture } from './Pages/ConfirmOrder';
...
function App() {
  ...
  return (
    <Routes>
        ...
        <Route path="/home" element={ <div className="flex"> <SideBar/><AjouterConseille/> <AjouterCodePromo/> <HomePage /></div>} />
        ...
        <Route path="/Confirm" element={adminRole == 0 ? <div className="flex"><SideBar/> <GenerateFacture/> <ConfirmOrder/> </div> : <Error/> } />
